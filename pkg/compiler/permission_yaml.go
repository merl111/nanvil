...
type yamlPermission manifest.Permission
...
func (p yamlPermission) MarshalYAML() (any, error) {
...
func (p *yamlPermission) UnmarshalYAML(node *yaml.Node) error {
...
func (p *yamlPermission) fillType(m map[string]any) error {
...
func (p *yamlPermission) fillMethods(m map[string]any) error {
